+++
title="Learning to Touch Type with Colemak"
date=2023-06-12
...
Then, there are also more layouts than Colemak, such as [Dvorak](https://dvorak-keyboard.com/) and [Workman](https://workmanlayout.org/). I found the switch from Swedish QWERTY to Colemak to be a good level of switch for me, but if you for example already are using an American layout, you perhaps want to try another layout, which forces enough new keys on you.
